package com.example.composestudy.library.network.retrofit

import com.example.composestudy.library.network.api.ApiService
...
import com.example.composestudy.library.network.model.NetworkRequestInfo
import com.example.composestudy.library.network.model.RequestType
...
class NetworkRequestFactoryImpl @Inject constructor(
    ...
    override suspend fun <T> create(
        ...
        return try {
            ...
            val responseCode = response.code()    // 200, 404, 300 등등
